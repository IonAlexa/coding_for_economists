...
#Try to assign the output to a variable
...
def cast_listitems_to_str(list_of_objects_):
  """"
  Cast all items in a list of strings.
...
print(cast_listitems_to_str([1, '3', 3,3]))
...
#Lambda functions (aka anonymus functions)
#Reference function
def square(x)
